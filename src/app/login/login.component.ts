 ...
 log_type='login';
  ...
  Register(event,role){
    ...
    if(role == 'buyer'){
      ...
      this.newService.RegisterUser(fname,lname,age,email,password,"buyer").subscribe(res=>{this.reg_res=res
    ...
    if(role == 'seller'){
      ...
      this.newService.RegisterSeller(fname,lname,age,email,password,"seller").subscribe((res)=>{
        this.reg_res=res
